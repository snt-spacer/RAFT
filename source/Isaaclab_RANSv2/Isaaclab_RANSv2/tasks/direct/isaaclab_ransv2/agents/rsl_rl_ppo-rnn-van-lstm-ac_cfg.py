...
"""LSTM recurrent policy with asymmetric critic (LSTM-AC) — E11 ablation.
...
- **Actor**: LSTM-RNN, sees only obs["policy"] (same as E10 LSTM variants).
...
Two variants:
  LSTM-64-AC  : rnn_hidden_dim=64
  LSTM-256-AC : rnn_hidden_dim=256
"""
...
@configclass
class PPORunnerCfgLSTM64AC(RslRlOnPolicyRunnerCfg):
    num_steps_per_env: int = 24
    max_iterations: int = 5000
    save_interval: int = 500
    experiment_name: str = "VAN_LSTM64_AC_GoToPosition"
...
@configclass
class PPORunnerCfgLSTM256AC(PPORunnerCfgLSTM64AC):
    experiment_name: str = "VAN_LSTM256_AC_GoToPosition"
